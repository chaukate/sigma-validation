...
namespace Sigma.Validation
{
    internal static class CheckPhoneNumber
    {
        ...
        /// <returns></returns>
        internal static ValidationResult<bool> ValidatePhoneNumber(this string phoneNumber)
        {
            var operation = new ValidationResult<bool>(false);
            try
            {
        ...
        private static void ValidateBrackets(string phoneNumber, ValidationResult<bool> operation)
        {
